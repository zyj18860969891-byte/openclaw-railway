...
| 技能名称 | 描述 | 所需依赖 |
|---------|------|---------|
| **api-integration** 🌐 | 专业数据源API集成，支持17个工具 | API密钥配置 |
...
| 技能名称 | 描述 | 所需依赖 |
|---------|------|---------|
| **api-integration** 🌐 | 专业数据源API集成，17个工具覆盖7个领域 | API密钥配置 |
...
- [x] **技能系统** - 53+ 内置技能（新增API集成技能）
- [x] **浏览器控制** - Chromium Headless 支持
- [x] **Canvas 画布** - 实时协作画布
- [x] **统一API客户端** - 支持12个专业数据源API
...
4. **智能家居** - 设备控制、场景联动
5. **内容创作** - 写作辅助、素材收集
6. **专业数据查询** - 金融、新闻、天气、健康、地理、学术、加密货币数据
