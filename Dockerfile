...
# Set build-time environment variables for plugin configuration
ARG FEISHU_APP_ID_1
ARG FEISHU_APP_SECRET_1
ARG DINGTALK_CLIENT_ID_1
ARG DINGTALK_CLIENT_SECRET_1
ENV FEISHU_APP_ID_1=${FEISHU_APP_ID_1:-} \
...
# Set build-time environment variables for other channels
ARG WECOM_CORP_ID_1
ARG WECOM_SECRET_1
ARG TELEGRAM_BOT_TOKEN_1
ARG DISCORD_BOT_TOKEN_1
ARG SLACK_BOT_TOKEN_1
ENV WECOM_CORP_ID_1=${WECOM_CORP_ID_1:-} \
    WECOM_SECRET_1=${WECOM_SECRET_1:-} \
    TELEGRAM_BOT_TOKEN_1=${TELEGRAM_BOT_TOKEN_1:-} \
    DISCORD_BOT_TOKEN_1=${DISCORD_BOT_TOKEN_1:-} \
